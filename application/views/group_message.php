		...
		<div class="box">
			<div class="box-header">
				<div class="box-name">
					...
					<span>Create Group Message form</span>
				</div>
				<div class="box-icons">
			...
			<div class="box-content">
				<h4 class="page-header">Create Group Message form</h4>
				<form class="form-horizontal" role="form" method="POST" action="<?=site_url()?>/main/submit_group_message">
